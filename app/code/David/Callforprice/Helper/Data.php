...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function loadFormUrl()
    {
		...
		// $form = $resultPage->getLayout()->createBlock('Magento\Framework\View\Element\Template')->assign('product',$product)->setTemplate('David_Callforprice::callforprice_form.phtml')->toHtml();
		// $resultJson = $this->_json->create();
		// return $resultJson->setData($form);
        return $this->_urlBuilder->getUrl('callforprice/form/load');
    }

    public function submitFormUrl()
    {
        return $this->_urlBuilder->getUrl('callforprice/form/submit');
    }
    ...
    public function getButtonCallPriceTemplate($product){
		$resultPage = $this->_resultPageFactory->create();
        return $resultPage->getLayout()->createBlock('Magento\Framework\View\Element\Template')->assign('product',$product)->setTemplate('David_Callforprice::button.phtml')->toHtml();
