...
return [
    'modules' => [
        ...
        'Adam_NewIn' => 1,
        'Bss_HelloWorld' => 1,
        'Ced_FeaturedSlider' => 1,
        'David_Callforprice' => 1,
        'David_Core' => 1,
        'David_CustomOrderNumber' => 1,
        'David_ProductQuickView' => 1,
        'David_QuickView' => 0,
        'Demo_News' => 1,
        'Demoo_Magento' => 1,
        'GardeningExpress_DisableLogin' => 1,
        'GhoSter_OutOfStockAtLast' => 1,
        'Gmrgold_CouponCodeAdmin' => 1,
        'Magebees_Finder' => 1,
        'Magen_Test' => 1,
        'Mageplaza_Core' => 1,
        ...
        'Magezon_UiBuilder' => 1,
        'Php4u_MagicLoginLink' => 1,
        'Products_Featured' => 1,
        'RLTSquare_ProductReviewImages' => 1,
        'SR_MagentoCommunity' => 1,
        'Street_Address' => 0,
        'StripeIntegration_Payments' => 1,
        'V2Agency_Bannerslider' => 1,
        'V2Agency_Core' => 1,
        'Webkul_MyCustomCollection' => 0
    ]
];
